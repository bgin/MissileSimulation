...
template<class Coords>  inline mathlib::Cartesian3D<Coords>::Cartesian3D(_In_ const Coords &X_Axis, _In_ const Coords &Y_Axis,
...
{
	this->m_OrientationQuaternions = std::array<mathlib::Quaternion, 3U>{};
...
template<class Coords> template<class OtherCoords> inline mathlib::Cartesian3D<Coords>::Cartesian3D(_In_ const OtherCoords &X,
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords>  inline mathlib::Cartesian3D<Coords>::Cartesian3D(_In_ const Cartesian3D &rhs) :
mX_Axis{ rhs.mX_Axis },
mY_Axis{ rhs.mY_Axis },
mZ_Axis{ rhs.mZ_Axis },
m_Type{ rhs.m_Type },
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords>  inline mathlib::Cartesian3D<Coords>::Cartesian3D(_In_ Cartesian3D &&rhs) :
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::operator=(_In_ const Cartesian3D &rhs)->mathlib::Cartesian3D<Coords> & {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
 template<class Coords> template<class OtherCoords>  inline auto mathlib::Cartesian3D<Coords>
	::operator=(_In_ const OtherCoords &rhs)->mathlib::Cartesian3D<Coords> & {
		if (this == &rhs) return (*this);
		/*
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::operator=(_In_ Cartesian3D &&rhs)->mathlib::Cartesian3D<Coords> & {
...
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::operator==(_In_ Cartesian3D &rhs)->std::array<__m256d, 6U> {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getX_Axis() const->Coords {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getY_Axis() const->Coords {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getZ_Axis() const->Coords {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getType() const->std::string {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getOrientQuaternions() const->std::array<mathlib::Quaternion, 3U> {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::isFixed() const->bool {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getXOrigin() const->double {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getYOrigin() const->double {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::getZOrigin() const->double {
...
//-----------------------------------------------------------------------------------------------------------------------------------//
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::displayCartesian3D() const->void {
...
template<class Coords> inline auto mathlib::Cartesian3D<Coords>::cross_prod()->mathlib::Cartesian3D<Coords> & {
