...
void          mathlib::RealFFT2D::real_fft_init2D(int L, int M, std::vector<float> &WSAVE, int LENSAV, int IER)
{
	RFFT2I(&L, &M, &WSAVE[0], &LENSAV, &IER);
}

void          mathlib::RealFFT2D::real_fft_backward2D(int LDIM, int L, int M, std::vector<float> &R,
...
void         mathlib::RealFFT2D::real_fft_forward2D(int LDM, int L, int M, std::vector<float> &R,
	std::vector<float> &WSAVE, int LENSAV, std::vector<float> &WORK, int LENWRK, int IER)
{
